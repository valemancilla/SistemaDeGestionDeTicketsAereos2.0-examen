...
public sealed class SystemStatusEntityConfiguration : IEntityTypeConfiguration<SystemStatusEntity>
{
    public void Configure(EntityTypeBuilder<SystemStatusEntity> builder)
    {
        ...
        builder.HasData(
            ...
            new SystemStatusEntity { IdStatus = 21, StatusName = "Emitido", EntityType = "Ticket" },
            new SystemStatusEntity { IdStatus = 22, StatusName = "Check-in realizado", EntityType = "Ticket" },
            new SystemStatusEntity { IdStatus = 25, StatusName = "Abordado", EntityType = "Ticket" },
            ...
            new SystemStatusEntity { IdStatus = 23, StatusName = "Generado", EntityType = "BoardingPass" },
            new SystemStatusEntity { IdStatus = 24, StatusName = "Activo", EntityType = "BoardingPass" }
        );
    }
}
